...
//if (isset($_GET["operation"]) && $_GET["operation"] == "edit"){
    if ($user-> CheckPermission($USERID, "permission_enclosure_edit") == 1 ) {
        $operation = 'updatemeters';
    } else {
        $operation = 'view';
    }
//}
...
//                         <input type="text" id="meter_'.$i.'" name="meter_'.$i.'" class="form-control meter-control" autocomplete="off"
...
function DrawEnclosure($gateway, $meters_config, $meter_type_id)
{
    ...
    if ($gateway == 1) {
        ...
        print '<input class="form-control editable" type="text" id="gateway_id" name="gateway_id" autocomplete="off" placeholder="'.$dictionary->GetValue("Gateway SN").'" tabindex="'.$tabIndex.'" '. ($gateway_sn ? 'value='.$gateway_sn : '') .'>';
    ...
    for ($i=0; $i<count($meters); $i++) {
        ...
        if ($meters[$i] == 0) {
            ...
            print '<div class="input-group">';
            print '<input type="text" id="meter_'.$i.'" name="meter_'.$i.'" class="form-control meter-control editable" autocomplete="off" tabindex="'.$tabIndex.'" value="'.$meter[$i+1].'">';
            ...
            print '<input type="text" disabled class="form-control meter-control" value="SN:'.$meter_serial_number[$i+1].'">';
        }
        print '</div></div>';
    }
    print '</div>';
...
?>
    <div class="row form">
        ...
        <div class="col-lg-9">
                    ...
                    <div class="well">
                        <div class="row">
                            <div class="col-lg-12 enclosurebox">
                                ...
                                <div class="form-group">
                                    <?php $html->Select("enclosure_configuration_id", $enclosure_configuration_id, $configurations, ["class"=>"form-control"]); ?>
                                </div>
            ...
            <?php if( ! $meter_count || $operation == 'updatemeters') { ?>
                <div class="col-lg-12">
                    <div class="row">
                        <?php /*
                        <div class="col-md-3">
