                    ...
                    <form action="code/enclosure.save.code.php" mathod="POST" role="form" class="form-horizontal form-row-seperated" style="display: <?php echo $add_enclosure_sn_display;?>" name="add_enclosure_sn" id="add_enclosure_sn" >
                        <div class="form-group alert">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn green save_enclosure" type="button">&nbsp;<i class="fa fa-check"></i>&nbsp;</button>
                                </span>
                            </div>
                            <br/>
                            <div class="input-group" style="width: 100%">
                                <button class="btn btn-block red revocation_enclosure" data-id="<?php print $enclosure_id ?>" type="button">&nbsp;<i class="fa fa-close"></i>&nbsp;<?php echo $dictionary->GetValue("revocation_enclosure");?></button>
                            </div>
                            <?php
...
?>
<script src="js/enclosure.js?v=3"></script>
<script>
