...
if ((isset($_REQUEST['team_id']) && $_REQUEST['team_id'] != "")) {
    $team_config_data["team_id"] = $_REQUEST['team_id'];
}

if ((isset($_REQUEST['enclosure_config_id']) && $_REQUEST['enclosure_config_id'] != "")) {
    $team_config_data["enclosure_config_id"] = $_REQUEST['enclosure_config_id'];
}

$result=$AssemblyTeam->AddTeamConfig($team_config_data);
