...
//print_r($assembly_order_data['trnasformers']);

// if (isset($_REQUEST["assembly_order_id"]) && $_REQUEST["assembly_order_id"] != null) {
// 	//update
// 	$id = $_REQUEST["assembly_order_id"];
// } else {
// 	//insert
// }
$id = $Assembly->AddAssemlyOrder($assembly_order_data);
...
header("Location: ../add_assembly.php?id=$id");
?>
