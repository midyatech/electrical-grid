...
if ((isset($_REQUEST['enclosure_status']) && $_REQUEST['enclosure_status'] != "")) {
    $enclosure_status = $_REQUEST['enclosure_status'];
    $enclosure_meters_data["enclosure_status"] = $enclosure_status;
}
...
if (!$error) {
    $result = $Enclosure->AddEnclosureMeters($enclosure_meters_data, $meters_data, $USERID);
