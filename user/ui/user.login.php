            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset">
                    <div class="login-bg" style="position: relative; z-index: 0; background: none;">
                        <img class="login-logo" src="../assets/pages/img/login/logo.png"> <div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 322px; width: 673px; z-index: -999998; position: absolute;"><img src="../assets/pages/img/login/bg1.jpg" style="position: absolute; margin: 0px; padding: 0px; border: none; width: 673px; height: 605.7px; max-height: none; max-width: none; z-index: -999999; left: 0px; top: -141.85px;"></div></div>
                </div>
